...
export function Onboarding({ onComplete }: { onComplete: (openingBalance: number, protect: boolean, displayName: string, userType?: UserType) => Promise<void> }) {
